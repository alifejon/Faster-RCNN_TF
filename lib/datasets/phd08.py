...
import subprocess
import uuid
from phd08_eval import phd08_eval
...
class phd08(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'phd08_' + image_set)
        # self._year = year
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = self._get_default_path() if devkit_path is None \
                            else devkit_path
        self._data_path = os.path.join(self._devkit_path, 'phd08')
        ...
        assert os.path.exists(self._devkit_path), \
                'phd08 path does not exist: {}'.format(self._devkit_path)
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'phd08')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_phd08_annotation(index)
    ...
    def _load_phd08_annotation(self, index):
        """
    ...
    def _write_phd08_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} phd08 results file'.format(str(cls.encode('utf-8')))
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_phd08_results_file(all_boxes)
